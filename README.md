...
Hệ thống phân loại ảnh thông minh sử dụng Machine Learning  phân loại với exif file của ảnh raw kết hợp Computer Vision để tự động phân loại và gán nhãn ảnh theo danh mục và tên người.
